...
use App\Orchid\Screens\UIteam\TeamListScreen;
...
// Platform > Store > Stock
Route::screen('stocks', StockListScreen::class)
    ->name('platform.store.stocks');
        //->push(__('Stocks'), route('platform.store.stocks'));
...
// Platform > System > Team List
Route::screen('teamids', TeamListScreen::class)
    ->name('platform.systems.team')
    ->breadcrumbs(fn (Trail $trail) => $trail
        ->parent('platform.index')
        ->push(__('Team'), route('platform.systems.team')));
